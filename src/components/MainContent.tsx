...
export default function MainContent({ activeComponent, setActiveComponent }: MainContentProps) {
  const [registeredBackHandler, setRegisteredBackHandler] = useState(() => () => false);
    ...
    <Box w="100%" h="100vh" bg="primary.200" safeArea>
      ...
      >
        ...
        <Button
          ...
          h={12}
        >
          <svg width="30" height="30" viewBox="0 0 30 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M16 3H27V45H16V3Z" fill="currentColor"/>
            <path d="M3 3H14V45H3V3Z" fill="currentColor"/>
            <path d="M21 23.5C21 24.3284 20.3284 25 19.5 25C18.6716 25 18 24.3284 18 23.5C18 22.6716 18.6716 22 19.5 22C20.3284 22 21 22.6716 21 23.5Z" fill="currentColor"/>
            <path d="M12 23.5C12 24.3284 11.3284 25 10.5 25C9.67157 25 9 24.3284 9 23.5C9 22.6716 9.67157 22 10.5 22C11.3284 22 12 22.6716 12 23.5Z" fill="currentColor"/>
          </svg>
        </Button>
        ...
        <Button
          ...
          h={12}
        >
          <svg width="33" height="33" viewBox="0 0 33 47" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M31.5719 5.8136C31.5719 5.8136 25.8686 0.83288 20.5597 1.0257C17.891 5.38489 15.9589 5.10209 11.9414 1.0257C8.13725 0.705028 4.50711 3.41966 2 7.24998L4.50711 10.9998L9.54749 9.64394V22.2206H23.9112V9.64394L29.1779 10.9998L31.5719 5.8136Z" stroke="currentColor" strokeWidth="2"/>
            <path d="M5.42845 45.5533L9.54749 26.4016H23.9112L29.2142 45.5533H19.6384L17.2081 33.1047L14.778 45.5533H5.42845Z" stroke="currentColor" strokeWidth="2"/>
          </svg>
        </Button>
        ...
        <Button
          ...
          h={12}
        >
          <svg width="29" height="29" viewBox="0 0 29 42" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path 
